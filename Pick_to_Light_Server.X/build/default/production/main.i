...
void can_demo()
{
    ...
    flag = 1;
        ...
        if(flag == 1)
        {
            ...
            can_payload[5] = send_arr[4];
   can_payload[6] = send_arr[5];
   can_payload[7] = send_arr[6];
   can_payload[8] = send_arr[7];
   can_payload[9] = send_arr[0];
   can_payload[10] = send_arr[1];
   can_payload[11] = send_arr[2];
   can_payload[12] = send_arr[3];
...
void main(void)
{
        ...
        if (can_receive())
  {
   ...
   pid[0] = can_payload[9];
   pid[1] = can_payload[10];
   pid[2] = can_payload[11];
   pid[3] = can_payload[12];
            pid[4] = '\0';
